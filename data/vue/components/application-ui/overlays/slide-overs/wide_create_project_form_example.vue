                ...
                <div class="px-4 py-6 bg-gray-50 sm:px-6">
                  <div class="flex items-start justify-between space-x-3">
                    ...
                    <div class="h-7 flex items-center">
                      <button @click="open = false; setTimeout(() => open = true, 1000);" class="bg-white rounded-md text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                        ...
                        <div class="space-y-5 sm:mt-0">
                            ...
                            <div class="relative flex items-start">
                              <div class="absolute flex items-center h-5">
                                  ...
                                  <input id="public_access" name="public_access" aria-describedby="public_access_description" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300" checked="">
                                </div>
                            ...
                            <div class="relative flex items-start">
                              <div class="absolute flex items-center h-5">
                                  ...
                                  <input id="restricted_access" name="restricted_access" aria-describedby="restricted_access_description" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                </div>
                              <div class="pl-7 text-sm">
                            ...
                            <div class="relative flex items-start">
                              <div class="absolute flex items-center h-5">
                                  ...
                                  <input id="private_access" name="private_access" aria-describedby="private_access_description" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                </div>
                              <div class="pl-7 text-sm">
                        ...
                        <div class="flex flex-col space-between space-y-4 sm:flex-row sm:items-center sm:space-between sm:space-y-0">
                          <div class="flex-1">
                            <a href="#" class="group flex items-center text-sm text-indigo-600 hover:text-indigo-900 font-medium space-x-2.5">
                              <svg class="h-5 w-5 text-indigo-500 group-hover:text-indigo-900" x-description="Heroicon name: solid/link" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
