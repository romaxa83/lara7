<template>
    <div class="bg-gray-100 h-screen" style="min-height: 660px;">
                    ...
                    <div class="mt-6 sm:ml-6 sm:flex-1">
                      ...
                      <div class="mt-5 flex flex-wrap space-y-3 sm:space-y-0 sm:space-x-3">
                        ...
                        <span class="ml-3 inline-flex sm:ml-0">
                          <div @keydown.window.escape="open = false" @click.away="open = false" class="relative inline-block text-left">
                            <button id="options-menu" @click="open = !open" type="button" class="inline-flex items-center p-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-400 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
