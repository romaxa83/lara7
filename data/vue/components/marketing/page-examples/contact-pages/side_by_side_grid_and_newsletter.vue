<template>
    ...
    <div class="min-h-screen bg-white">
      <header class="relative pb-24 bg-light-blue-800 sm:pb-32">
        <div class="absolute inset-0">
          ...
          <div class="absolute inset-0 bg-gradient-to-l from-light-blue-800 to-cyan-700" style="mix-blend-mode: multiply;" aria-hidden="true"></div>
        </div>
          ...
          <nav class="relative max-w-7xl mx-auto flex items-center justify-between pt-6 pb-2 px-4 sm:px-6 lg:px-8" aria-label="Global">
            <div class="flex items-center justify-between w-full lg:w-auto">
              ...
              <div class="-mr-2 flex items-center lg:hidden">
                <button type="button" class="bg-light-blue-800 bg-opacity-0 rounded-md p-2 inline-flex items-center justify-center text-cyan-100 hover:bg-opacity-100 focus:outline-none focus:ring-2 focus-ring-inset focus:ring-white" @click="toggle" @mousedown="if (open) $event.preventDefault()" aria-expanded="false" :aria-expanded="open.toString()">
    ...
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path>
            ...
            <div class="hidden space-x-10 lg:flex lg:ml-10">
                ...
                <a href="#" class="text-base font-medium text-white hover:text-cyan-100">Parnters</a>
            ...
            <transition enter-active-class="duration-150 ease-out" enter-class="opacity-0 scale-95" enter-to-class="opacity-100 scale-100" leave-active-class="duration-100 ease-in" leave-class="opacity-100 scale-100" leave-to-class="opacity-0 scale-95"><div v-if="open" x-description="Mobile menu, show/hide based on menu open state." class="absolute top-0 inset-x-0 p-2 transition transform origin-top lg:hidden" x-ref="panel" @click.away="open = false">
              <div class="rounded-lg shadow-lg bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                <div class="px-5 pt-4 flex items-center justify-between">
                  ...
                  <div class="-mr-2">
                    <button type="button" class="bg-white rounded-md p-2 inline-flex items-center justify-center text-warm-gray-400 hover:bg-warm-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-green-500" @click="toggle">
              ...
              <div class="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  ...
                  <ul class="mt-4 space-y-4">
                      ...
                      <li>
                        <a href="#" class="text-base text-warm-gray-500 hover:text-warm-gray-900">
                          Marketing
                        </a>
                      </li>
